...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 31 11:45:15 2025
...
# Extract data for each measurement type and SLICE TO TRIALS 1-15 ONLY
KO_latency = ATRX_trial['Latency'][KO_mice].iloc[:21]  # Only trials 1-15
WT_latency = ATRX_trial['Latency'][WT_mice].iloc[:21]  # Only trials 1-15

KO_distance = ATRX_trial['Distance'][KO_mice].iloc[:21]  # Only trials 1-15
WT_distance = ATRX_trial['Distance'][WT_mice].iloc[:21]  # Only trials 1-15

KO_speed = ATRX_trial['Speed'][KO_mice].iloc[:21]  # Only trials 1-15
WT_speed = ATRX_trial['Speed'][WT_mice].iloc[:21]  # Only trials 1-15
