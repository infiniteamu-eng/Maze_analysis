...
def plot_path_efficiency_comparison():
    ...
    ax1.set_ylabel('Path Efficiency', fontsize=16)
    ...
    early_trials = range(12, 13)  # Trials 1-5
    late_trials = range(20,21)  # Trials 11-15
    ...
    ax2.set_ylabel('Path Efficiency', fontsize=16)
